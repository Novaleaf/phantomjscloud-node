...
*/
export class PhantomJsCloudException<TData=void> extends xlib.exception.Exception<TData> {
}
...
export class BrowserApi {
    ...
    private _defaultBrowserOptions: IBrowserApiOptions = {
        ...
        endpointOptions: {
            ...
            autoscalerOptions: { busyGrowDelayMs: 30000, busyPenalty: 2, growDelayMs: 3000, decayDelayMs: 5000, minParallel: 4 },
            endpoint: {},
    ...
    private _endpoint: xlib.net.RemoteHttpEndpoint<ioDatatypes.IUserRequest, ioDatatypes.IUserResponse>;
