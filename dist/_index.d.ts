...
export declare class BrowserApi {
     ...
     * @param task
     */
    private _task_worker;
    /**
     * make a single browser request (PhantomJs call)
     * @param request
     * @param callback
     */
    requestSingle(request: ioDatatypes.IUserRequest | ioDatatypes.IPageRequest, callback?: (err: Error, result: ioDatatypes.IUserResponse) => void): Promise<ioDatatypes.IUserResponse>;
    requestSingle(request: ioDatatypes.IUserRequest | ioDatatypes.IPageRequest, customOptions?: IBrowserApiOptions, callback?: (err?: Error, result?: ioDatatypes.IUserResponse) => void): Promise<ioDatatypes.IUserResponse>;
    /**
